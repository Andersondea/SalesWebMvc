...
namespace SalesWebMvc.Services
{
    public class SellerService
    {
        ...
        public async Task<List<Seller>> FindAllAsync() => await _contex.Seller.ToListAsync();
        ...
        {            
            ...
            {
                throw new IntegrityException("Vendedor com vendas, não pode ser excluído.");
            }
        }

        public async Task UpdateAsync(Seller obj)
        {
            if (! await _contex.Seller.AnyAsync(s => s.Id == obj.Id))
            {
